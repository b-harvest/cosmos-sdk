...
type BlsKey struct {
	...
	Pubkey *github_com_babylonchain_babylon_crypto_bls12381.PublicKey `protobuf:"bytes,2,opt,name=pubkey,proto3,customtype=github.com/cosmos/cosmos-sdk/crypto/keys/bls12381.PublicKey" json:"pubkey,omitempty"`
