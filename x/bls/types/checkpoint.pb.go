...
import (
	bytes "bytes"
	fmt "fmt"
	github_com_babylonchain_babylon_crypto_bls12381 "github.com/cosmos/cosmos-sdk/crypto/keys/bls12381"
...
type RawCheckpoint struct {
	...
	// sigs
	BlsMultiSig *github_com_babylonchain_babylon_crypto_bls12381.Signature `protobuf:"bytes,4,opt,name=bls_multi_sig,json=blsMultiSig,proto3,customtype=github.com/cosmos/cosmos-sdk/crypto/keys/bls12381.Signature" json:"bls_multi_sig,omitempty"`
}
...
type RawCheckpointWithMeta struct {
	...
	BlsAggrPk *github_com_babylonchain_babylon_crypto_bls12381.PublicKey `protobuf:"bytes,3,opt,name=bls_aggr_pk,json=blsAggrPk,proto3,customtype=github.com/cosmos/cosmos-sdk/crypto/keys/bls12381.PublicKey" json:"bls_aggr_pk,omitempty"`
...
type BlsSig struct {
	...
	LastCommitHash *LastCommitHash                                            `protobuf:"bytes,2,opt,name=last_commit_hash,json=lastCommitHash,proto3,customtype=LastCommitHash" json:"last_commit_hash,omitempty"`
	BlsSig         *github_com_babylonchain_babylon_crypto_bls12381.Signature `protobuf:"bytes,3,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/cosmos/cosmos-sdk/crypto/keys/bls12381.Signature" json:"bls_sig,omitempty"`
