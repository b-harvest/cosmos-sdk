...
func (msg MsgCreateSubKeyAccount) Route() string { return RouterKey }

// Type Implements Msg.
func (msg MsgCreateSubKeyAccount) Type() string { return "create_subkey_account" }

// ValidateBasic Implements Msg.
func (msg MsgCreateSubKeyAccount) ValidateBasic() sdk.Error {
	if msg.CreatorAddress.Empty() {
		return sdk.ErrInvalidAddress("missing creator address")
	}
	if msg.MasterPubKey == nil {
		return sdk.ErrInvalidPubKey("missing pubkey")
	}
	return nil
}

// GetSignBytes Implements Msg.
func (msg MsgCreateSubKeyAccount) GetSignBytes() []byte {
	return sdk.MustSortJSON(msgCdc.MustMarshalJSON(msg))
}

// GetSigners Implements Msg.
func (msg MsgCreateSubKeyAccount) GetSigners() []sdk.AccAddress {
