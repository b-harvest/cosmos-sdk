...
type Params struct {
	...
	// When a farmer creates new staking_position, the farmer needs to pay staking_position_creation_fee to prevent spam
	// on the staking_position struct.
	StakingPositionCreationFee github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=staking_position_creation_fee,json=stakingPositionCreationFee,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"staking_position_creation_fee" yaml:"staking_position_creation_fee"`
...
func (m *Params) GetStakingPositionCreationFee() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.StakingPositionCreationFee
	}
	return nil
}
...
type Reward struct {
	...
	StakingCoinDenom uint64 `protobuf:"varint,2,opt,name=staking_coin_denom,json=stakingCoinDenom,proto3" json:"staking_coin_denom,omitempty" yaml:"staking_coin_denom"`
	// reward_coins specifies rewards amount at this point in time when farmers receive them from the farming plan
	RewardCoins github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=reward_coins,json=rewardCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"reward_coins" yaml:"reward_coins"`
}
...
var fileDescriptor_0abc81cc983fe36f = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StakingPositionCreationFee) > 0 {
		for iNdEx := len(m.StakingPositionCreationFee) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.StakingPositionCreationFee[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Reward) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StakingCoinDenom != 0 {
		i = encodeVarintFarming(dAtA, i, uint64(m.StakingCoinDenom))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Farmer) > 0 {
...
func (m *Params) Size() (n int) {
	...
	if len(m.StakingPositionCreationFee) > 0 {
		for _, e := range m.StakingPositionCreationFee {
			l = e.Size()
			n += 1 + l + sovFarming(uint64(l))
		}
	}
...
func (m *Reward) Size() (n int) {
	...
	if m.StakingCoinDenom != 0 {
		n += 1 + sovFarming(uint64(m.StakingCoinDenom))
	}
	if len(m.RewardCoins) > 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakingPositionCreationFee", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StakingPositionCreationFee = append(m.StakingPositionCreationFee, types.Coin{})
			if err := m.StakingPositionCreationFee[len(m.StakingPositionCreationFee)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StakingCoinDenom |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			m.RewardCoins = append(m.RewardCoins, types.DecCoin{})
