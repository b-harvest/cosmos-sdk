...
func (m *MsgHarvest) GetStakingCoinDenom() uint64 {
	if m != nil {
...
var fileDescriptor_c8e8c5aa94d8db2d = []byte{
	...
	,
}
...
func (m *MsgHarvest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StakingCoinDenom != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.StakingCoinDenom))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Farmer) > 0 {
...
func (m *MsgHarvest) Size() (n int) {
	...
	if m.StakingCoinDenom != 0 {
		n += 1 + sovTx(uint64(m.StakingCoinDenom))
	}
	return n
}
